...
public class inventoryDTO {
    ...
    public inventoryDTO(String inventoryId, String inventoryName, String qtyOnHand,
    ...
    public inventoryDTO(String inventoryName, String qtyOnHand, String inventoryType, LocalDate stockInDate) {
        this.inventoryName = inventoryName;
        this.qtyOnHand = qtyOnHand;
        this.inventoryType = inventoryType;
        this.stockInDate = stockInDate;
