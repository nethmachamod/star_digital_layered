...
public class supplierDTO {
    ...
    public supplierDTO(String supname, String supcontact, LocalDate supdate, String supagency, String companyname, String supstatus, String imagepath) {
    ...
    public supplierDTO(int supid, String supname, String supcontact, LocalDate supdate, String supagency, String companyname, String supstatus, String imagepath) {
        this.supid = supid;
        this.supname = supname;
        this.supcontact = supcontact;
        this.supdate = supdate;
